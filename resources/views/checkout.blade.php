                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('payment') }}" method="POST" id="subscribe-form">
                            ...
                            <div class="row mb-3 text-primary">
                                <label for="title" class="col-md-4"><b>Product</b></label>
                                <div class="col-md-8">{{ $products->name }}</div>
                            </div>
                            <div class="row mb-3 text-primary">
                                <label for="title" class="col-md-4"><b>Price</b></label>
                                <div class="col-md-8">{{ $products->price }}</div>
                            </div>
                            <div class="form-row">
